...
*   **音量平衡控制**：
    *   音量平衡可設為 1x～10x，預設 5x。
    *   用於弭平高音聽感較大聲的差異，並可提升最低音的存在感；高倍率下會自動套用頻率優化以減少雜音。
*   **音孔遮擋哇哇音效果**：
...
3.  **彈奏**：
    ...
    *   **電腦**：使用滑鼠點擊琴鍵。
    *   可調整最低音/最高音、Release 與音量平衡（1x～10x，預設 5x）；音量平衡可提升最低音以弭平高音聽感較大聲，並套用全頻段增益優化。按住音孔可做遮擋哇哇音，放開後恢復。
